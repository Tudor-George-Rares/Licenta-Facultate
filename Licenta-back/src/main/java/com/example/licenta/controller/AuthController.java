...
import com.example.licenta.payload.request.SignupRequest;
import com.example.licenta.payload.response.JwtResponse;
import com.example.licenta.payload.response.MessageResponse;
import com.example.licenta.repository.RoleRepository;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(),
        ...
        signUpRequest.getNume(), // Include new fields
        signUpRequest.getPrenume(),
        signUpRequest.getTelefon(),
        signUpRequest.getAdresaCompleta());
